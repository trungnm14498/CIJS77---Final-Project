...
const ItemDetail = () => {
    ...
    return (
        <section className="xl:max-w-[1280px] w-full mx-auto sm:px-10 px-20 flex flex-col sm:mt-40 mt-28">
            {itemDisplay && (
                <div className='w-fit'>
                    <h2 className='font-play sm:text-7xl ss:text-5xl text-3xl text-gradient uppercase inline-block'>{window.location.pathname.substr(6).slice(0, -(1 + itemId.length))}</h2>
            ...
            {itemDisplay && (
                <div className='flex xs:flex-row flex-col justify-center items-center md:gap-40 sm:gap-20 gap-16 mt-20'>
                    <div className="picture">
                        <img src={itemDisplay.image} alt="{itemDisplay[0].name}" className='md:w-[480px] md:h-[480px] sm:w-[400px] sm:h-[400px] ss:w-[250px] ss:h-[250px] w-[190px] h-[190px]' />
                    </div>
                    ...
                    <div className='sm:w-[500px] w-[320px] h-fit border-2 border-solid border-primary'>
                        ...
                        <div className='flex flex-col gap-5 sm:p-10 p-5 sm:text-xl text-lg text-dimWhite'>
                            <p className='text-center sm:mb-12 mb-5'>
                                {itemDisplay.detail.desc}
                            </p>
                            ...
                            <div className='flex justify-center items-center gap-10'>
                                ...
                                <Link to='/menu/starter' className="btn-sub text-lg sm:mb-2 w-fit">Back To Menu</Link>
                            </div>
