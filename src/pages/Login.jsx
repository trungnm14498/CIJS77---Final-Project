        ...
        <section className="xl:max-w-[1280px] w-full mx-auto sm:px-10 px-20 flex flex-col sm:mt-40 mt-28">
            ...
            <form className="w-full max-w-sm mx-auto mt-28" action="/" method="post">
                ...
                <div className="md:flex md:items-center mb-6">
                    ...
                    <div className="md:w-2/3">
                        <input className="bg-transparent appearance-none border border-solid border-primary rounded w-full py-2 px-4 text-white leading-tight focus:outline-none" id="password" type="password" placeholder="******************" />
                    </div>
                </div>
                <div className="md:flex md:items-center mb-6">
